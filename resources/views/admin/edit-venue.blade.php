<x-layout title="Edit Venue">
  <form action="/admin/venue/{{$venue->id}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="w-full h-16 border-b-2 p-4 border-b-slate-300 flex items-center justify-between">
      ...
      <h1 class="text-xl font-semibold text-[#063F5C]">Edit Venue</h1>
    ...
    <div class='p-6'>
      ...
      <div class=" bg-neutral-200 rounded-xl">
        ...
        <label for="image" class="cursor-pointer flex flex-col items-center justify-center p-4">
          <img src="{{asset($venue->image)}}" alt="vanue">
      ...
      <div class="mt-4">
        <h1 class="font-semibold text-base text text-[#063F5C]">Deskripsi Venue</h1>
